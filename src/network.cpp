...
// ============================================================================
// NETWORK - Network protocol and async I/O
// ============================================================================

NetworkManager::NetworkManager(const Config& cfg) : config_(cfg) { initialize(cfg); }

NetworkManager::~NetworkManager() { shutdown(); }

void NetworkManager::initialize(const Config& cfg) {
...
size_t NetworkManager::process(const uint8_t* data, size_t size) {
...
std::vector<uint8_t> NetworkManager::process_with_result(const uint8_t* data, size_t size) {
...
void NetworkManager::process_async(const uint8_t* data, size_t size,
...
void NetworkManager::reset_statistics() {
  std::unique_lock<std::shared_mutex> lock(mutex_);
  stats_ = {};
...
void NetworkManager::worker_thread() {
  while (running_) {
    std::this_thread::sleep_for(std::chrono::milliseconds(config_.timeout_ms / 10));
  }
}

void NetworkManager::update_statistics(size_t bytes, double latency) {
  std::unique_lock<std::shared_mutex> lock(mutex_);
...
void NetworkManager::log_message(const std::string& msg) {
...
/**
 * Detailed handler for network operation batch 0
 */
template <typename T>
...
/**
 * Batch optimization for network processing
 */
...
/**
 * Detailed handler for network operation batch 1
 */
template <typename T>
...
/**
 * Detailed handler for network operation batch 2
 */
template <typename T>
...
/**
 * Detailed handler for network operation batch 3
 */
template <typename T>
...
/**
 * Detailed handler for network operation batch 4
 */
template <typename T>
...
/**
 * Detailed handler for network operation batch 5
 */
template <typename T>
...
/**
 * Detailed handler for network operation batch 6
 */
template <typename T>
...
/**
 * Detailed handler for network operation batch 7
 */
template <typename T>
...
/**
 * Detailed handler for network operation batch 8
 */
template <typename T>
...
/**
 * Detailed handler for network operation batch 9
 */
template <typename T>
...
/**
 * Detailed handler for network operation batch 10
 */
template <typename T>
...
/**
 * Detailed handler for network operation batch 11
 */
template <typename T>
