...
IndexingManager::IndexingManager(const Config& cfg) : config_(cfg) { initialize(cfg); }

IndexingManager::~IndexingManager() { shutdown(); }
...
std::vector<uint8_t> IndexingManager::process_with_result(const uint8_t* data, size_t size) {
...
void IndexingManager::process_async(const uint8_t* data, size_t size,
