...
static Result verify_all_roundtrip_types(const std::string& path) {
  ...
  static Result (*checks[60])(uint16_t, const std::vector<uint8_t>&) = {
      text_roundtrip_check_0,  text_roundtrip_check_1,  text_roundtrip_check_2,
      text_roundtrip_check_3,  text_roundtrip_check_4,  text_roundtrip_check_5,
      text_roundtrip_check_6,  text_roundtrip_check_7,  text_roundtrip_check_8,
      text_roundtrip_check_9,  text_roundtrip_check_10, text_roundtrip_check_11,
      text_roundtrip_check_12, text_roundtrip_check_13, text_roundtrip_check_14,
      text_roundtrip_check_15, text_roundtrip_check_16, text_roundtrip_check_17,
      text_roundtrip_check_18, text_roundtrip_check_19, text_roundtrip_check_20,
      text_roundtrip_check_21, text_roundtrip_check_22, text_roundtrip_check_23,
      text_roundtrip_check_24, text_roundtrip_check_25, text_roundtrip_check_26,
      text_roundtrip_check_27, text_roundtrip_check_28, text_roundtrip_check_29,
      text_roundtrip_check_30, text_roundtrip_check_31, text_roundtrip_check_32,
      text_roundtrip_check_33, text_roundtrip_check_34, text_roundtrip_check_35,
      text_roundtrip_check_36, text_roundtrip_check_37, text_roundtrip_check_38,
      text_roundtrip_check_39, text_roundtrip_check_40, text_roundtrip_check_41,
      text_roundtrip_check_42, text_roundtrip_check_43, text_roundtrip_check_44,
      text_roundtrip_check_45, text_roundtrip_check_46, text_roundtrip_check_47,
      text_roundtrip_check_48, text_roundtrip_check_49, text_roundtrip_check_50,
      text_roundtrip_check_51, text_roundtrip_check_52, text_roundtrip_check_53,
      text_roundtrip_check_54, text_roundtrip_check_55, text_roundtrip_check_56,
      text_roundtrip_check_57, text_roundtrip_check_58, text_roundtrip_check_59,
  };
  uint32_t n = 0;
  while (!reader.eof()) {
    EventRecord rec;
