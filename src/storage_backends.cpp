...
Storage_BackendsManager::Storage_BackendsManager(const Config& cfg) 
    : config_(cfg) {
    initialize(cfg);
}

Storage_BackendsManager::~Storage_BackendsManager() {
    shutdown();
}
...
std::vector<uint8_t> Storage_BackendsManager::process_with_result(
...
public:
    BatchProcessor11(size_t batch_size = 4096)
        : batch_size_(batch_size), processed_(0) {}
...
public:
    BatchProcessor12(size_t batch_size = 4096)
        : batch_size_(batch_size), processed_(0) {}
