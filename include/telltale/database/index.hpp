...
uint64_t compute_hash_index(const void* data, size_t size) {
...
bool validate_index(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_index(const std::vector<uint8_t>& input) {
