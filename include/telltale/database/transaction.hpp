...
// Utility functions for transaction
namespace {

uint64_t compute_hash_transaction(const void* data, size_t size) {
...
bool validate_transaction(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_transaction(const std::vector<uint8_t>& input) {
