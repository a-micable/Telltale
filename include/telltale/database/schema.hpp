...
uint64_t compute_hash_schema(const void* data, size_t size) {
...
bool validate_schema(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_schema(const std::vector<uint8_t>& input) {
