...
uint64_t compute_hash_table(const void* data, size_t size) {
...
bool validate_table(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_table(const std::vector<uint8_t>& input) {
