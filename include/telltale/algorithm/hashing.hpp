...
uint64_t compute_hash_hashing(const void* data, size_t size) {
...
bool validate_hashing(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_hashing(const std::vector<uint8_t>& input) {
