...
public:
    ...
    Decoding& operator=(Decoding&&) = default;
...
uint64_t compute_hash_decoding(const void* data, size_t size) {
...
bool validate_decoding(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_decoding(const std::vector<uint8_t>& input) {
