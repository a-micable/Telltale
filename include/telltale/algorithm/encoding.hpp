...
uint64_t compute_hash_encoding(const void* data, size_t size) {
...
bool validate_encoding(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_encoding(const std::vector<uint8_t>& input) {
