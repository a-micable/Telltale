...
public:
    ...
    Sorting& operator=(Sorting&&) = default;
...
uint64_t compute_hash_sorting(const void* data, size_t size) {
...
bool validate_sorting(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_sorting(const std::vector<uint8_t>& input) {
