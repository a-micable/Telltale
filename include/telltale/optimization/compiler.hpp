...
uint64_t compute_hash_compiler(const void* data, size_t size) {
...
bool validate_compiler(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_compiler(const std::vector<uint8_t>& input) {
