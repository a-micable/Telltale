...
// Utility functions for vectorizer
namespace {

uint64_t compute_hash_vectorizer(const void* data, size_t size) {
...
bool validate_vectorizer(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_vectorizer(const std::vector<uint8_t>& input) {
