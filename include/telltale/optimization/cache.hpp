...
uint64_t compute_hash_cache(const void* data, size_t size) {
...
bool validate_cache(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_cache(const std::vector<uint8_t>& input) {
