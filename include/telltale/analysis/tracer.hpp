...
// Utility functions for tracer
namespace {

uint64_t compute_hash_tracer(const void* data, size_t size) {
...
bool validate_tracer(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_tracer(const std::vector<uint8_t>& input) {
