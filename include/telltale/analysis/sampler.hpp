...
uint64_t compute_hash_sampler(const void* data, size_t size) {
...
bool validate_sampler(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_sampler(const std::vector<uint8_t>& input) {
