...
uint64_t compute_hash_debugger(const void* data, size_t size) {
...
bool validate_debugger(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_debugger(const std::vector<uint8_t>& input) {
