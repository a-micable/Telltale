...
uint64_t compute_hash_monitor(const void* data, size_t size) {
...
bool validate_monitor(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_monitor(const std::vector<uint8_t>& input) {
