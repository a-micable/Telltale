...
// Utility functions for profiler
namespace {

uint64_t compute_hash_profiler(const void* data, size_t size) {
...
bool validate_profiler(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_profiler(const std::vector<uint8_t>& input) {
