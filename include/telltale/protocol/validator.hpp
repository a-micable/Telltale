...
uint64_t compute_hash_validator(const void* data, size_t size) {
...
bool validate_validator(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_validator(const std::vector<uint8_t>& input) {
