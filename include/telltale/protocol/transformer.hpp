...
uint64_t compute_hash_transformer(const void* data, size_t size) {
...
bool validate_transformer(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_transformer(const std::vector<uint8_t>& input) {
