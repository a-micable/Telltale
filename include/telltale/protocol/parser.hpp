...
uint64_t compute_hash_parser(const void* data, size_t size) {
...
bool validate_parser(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_parser(const std::vector<uint8_t>& input) {
