...
uint64_t compute_hash_encoder(const void* data, size_t size) {
...
bool validate_encoder(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_encoder(const std::vector<uint8_t>& input) {
