...
uint64_t compute_hash_serializer(const void* data, size_t size) {
...
bool validate_serializer(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> transform_serializer(const std::vector<uint8_t>& input) {
