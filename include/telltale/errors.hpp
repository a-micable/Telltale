...
public:
    ...
    static std::string error_code_name(ErrorCode code) {
        switch (code) {
            ...
            case ErrorCode::HeaderCrcMismatch: return "HeaderCrcMismatch";
            case ErrorCode::RecordCrcMismatch: return "RecordCrcMismatch";
            ...
            case ErrorCode::HandlerAlreadyRegistered: return "HandlerAlreadyRegistered";
            case ErrorCode::HandlerTableFull: return "HandlerTableFull";
            case ErrorCode::InvalidSchemaUpdate: return "InvalidSchemaUpdate";
            case ErrorCode::InvalidTypeId: return "InvalidTypeId";
            case ErrorCode::InvalidHandlerId: return "InvalidHandlerId";
            case ErrorCode::ChecksumMismatch: return "ChecksumMismatch";
            case ErrorCode::BatchTooLarge: return "BatchTooLarge";
            case ErrorCode::NameTooLong: return "NameTooLong";
            case ErrorCode::StringTooLong: return "StringTooLong";
            case ErrorCode::InvalidFlags: return "InvalidFlags";
            case ErrorCode::StateError: return "StateError";
            case ErrorCode::FinalizeError: return "FinalizeError";
            case ErrorCode::OpenError: return "OpenError";
            case ErrorCode::SeekError: return "SeekError";
            case ErrorCode::TruncatedRecord: return "TruncatedRecord";
            case ErrorCode::EmptyFile: return "EmptyFile";
            case ErrorCode::DuplicateCounter: return "DuplicateCounter";
            case ErrorCode::InvalidBatchStructure: return "InvalidBatchStructure";
            case ErrorCode::MaxRegistrationsExceeded: return "MaxRegistrationsExceeded";
